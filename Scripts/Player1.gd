...
func _ready():
	var up_input = "ui_up" if is_player_1 else "ui_up2"
	var down_input = "ui_down" if is_player_1 else "ui_down2"
	var attack_input = "ui_right" if is_player_1 else "ui_left2"
...
func _physics_process(delta):
	...
	position.y = clamp(position.y, 150, screensize.y-100)
